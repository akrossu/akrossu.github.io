...
<div class="w-72 mr-16 hidden md:block min-w-fit h-auto">
    ...
    <div class="px-8">
        ...
        <ul class="mb-4 list-none">
            ...
            <li aria-label="page description">&gt playing/completed games</li>
        ...
        <ul class="mb-4 list-none">
            ...
            <li aria-label="page description">&gt about the webmaster</li>
        ...
        <ul class="mb-4 list-none">
            ...
            <li aria-label="page description">&gt record your visit</li>
            <li><a class="normal-case" href="https://www.discord.gg/sczXWkDsZ6" target="_blank">[ discord.gg/sczXWkDsZ6 ]</a></li>
            <li aria-label="page description">&gt community discord</li>
        </ul>
    </div>
</div>
